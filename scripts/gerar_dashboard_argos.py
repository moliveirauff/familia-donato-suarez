...
Lógica de valuation: cada aporte corrigido em 0,6% a.m. composto
...
def main():
    ...
    output = {
        ...
        'metodologia': 'Aportes corrigidos a 0,6% a.m. composto. Participacao: 1/3. Valuation empresa = minha parte x 3.',
        'kpis': {
